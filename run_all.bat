...
start "AI Trader" cmd /k "c:\users\a2515\appdata\local\hermes\hermes-agent\venv\Scripts\python.exe ai_trader.py"

echo [4/9] Starting Index Cache Updater...
start "Index Cache Updater" cmd /k "c:\users\a2515\appdata\local\hermes\hermes-agent\venv\Scripts\python.exe feeds\index_updater.py"

echo [5/9] Starting News Fetcher...
start "News Fetcher" cmd /k "c:\users\a2515\appdata\local\hermes\hermes-agent\venv\Scripts\python.exe datahub\news_fetcher.py"

echo [6/9] Starting Event Extractor...
start "Event Extractor" cmd /k "c:\users\a2515\appdata\local\hermes\hermes-agent\venv\Scripts\python.exe nlp\event_extractor.py"
